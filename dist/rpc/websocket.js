...
var WebsocketClientJson = /** @class */ (function () {
    function WebsocketClientJson(baseUrl, server) {
        ...
        this.server = server;
        this.interceptor = new SocketInterceptor(function (data, next) {
            return _this.socketInvoke(data, next);
        });
    }
    ...
    WebsocketClientJson.prototype.connect = function (prams) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                _this.socket = new WebSocket(_this.baseUrl, [encodeURIComponent(temp)]);
